...
export function StatusBar({ trackCount, selectedCount = 0 }: StatusBarProps) {
  ...
  return (
    <div className="h-6 flex items-center justify-between px-3 bg-[#252535] border-t border-[#2a2a3a] text-[10px] text-gray-400">
      ...
      {/* Right: Library Info */}
      <div className="flex items-center gap-4">
        <span className="text-gray-500">Library: {tracks.length} tracks</span>
      </div>
    </div>
  );
}
